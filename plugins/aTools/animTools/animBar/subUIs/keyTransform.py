...
from Framework.plugins.aTools.animTools.animBar.subUIs import tangents;   reload(tangents)
from Framework.plugins.aTools.animTools.animBar.subUIs.specialTools_subUIs import mirror;   reload(mirror)
