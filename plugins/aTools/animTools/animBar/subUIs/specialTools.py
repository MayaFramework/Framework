...
from Framework.plugins.aTools.commonMods import uiMod;   reload(uiMod)
...
for loopMod in MODULES:
    exec("from Framework.plugins.aTools.animTools.animBar.subUIs.specialTools_subUIs import %s; reload(%s)"%(loopMod, loopMod))
