...
from Framework.plugins.aTools.generalTools        import aToolsClasses;               reload(aToolsClasses)
from Framework.plugins.aTools.commonMods          import animMod;                     reload(animMod)
from Framework.plugins.aTools.generalTools        import generalToolsUI;              reload(generalToolsUI)
from Framework.plugins.aTools.commonMods          import utilMod;                     reload(utilMod)
from Framework.plugins.aTools.commonMods          import commandsMod;                 reload(commandsMod)
from Framework.plugins.aTools.commonMods          import aToolsMod;                   reload(aToolsMod)
from Framework.plugins.aTools                     import setup;                       reload(setup)
...
for loopMod in SUB_UI_MODS:
    exec("import Framework.plugins.aTools.animTools.animBar.subUIs.%s as %s; reload(%s)"%(loopMod, loopMod, loopMod))
