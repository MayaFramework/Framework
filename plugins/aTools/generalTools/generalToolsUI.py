...
from Framework.plugins.aTools.generalTools.aToolsGlobals import aToolsGlobals as G
from Framework.plugins.aTools.commonMods      import uiMod
from Framework.plugins.aTools.commonMods      import utilMod
from Framework.plugins.aTools.commonMods      import animMod
from Framework.plugins.aTools.commonMods      import commandsMod
from Framework.plugins.aTools.commonMods      import aToolsMod
from Framework.plugins.aTools                 import setup
from Framework.plugins.aTools.generalTools    import hotkeys;                     reload(hotkeys)
from Framework.plugins.aTools.generalTools    import tumbleOnObjects;             reload(tumbleOnObjects)
from Framework.plugins.aTools.animTools       import animationCrashRecovery;      reload(animationCrashRecovery)
from Framework.plugins.aTools.animTools       import framePlaybackRange;          reload(framePlaybackRange)
from Framework.plugins.aTools.animTools       import jumpToSelectedKey;           reload(jumpToSelectedKey)
...
class GeneralTools_Gui(uiMod.BaseSubUI):
    ...
    def uninstall(self, *args):
        ...
        if confirm == 'Yes':      
            ...
            from Framework.plugins.aTools.animTools.animBar import animBarUI; reload(animBarUI)
...
def shelfButton(*args):
    ...
    command         = "from Framework.plugins.aTools.animTools.animBar import animBarUI; animBarUI.show('toggle')"
